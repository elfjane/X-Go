...
var Logins = require('src/logins');

var pogoSignature = require('node-pogo-signature');

var builder = ProtoBuf.loadProtoFile('data/pokemon.proto');
if (builder === null) {
  builder = ProtoBuf.loadProtoFile(__dirname + '/pokemon.proto');
}
var request_type = require('data/request_type.json');			// 請求type
...
function Pokeio() {
  ...
  self.GetApiEndpoint = function (callback) {
    ...
    api_req(api_url, self.playerInfo.accessToken, req, function (err, f_ret) {
	  ...
	  if (f_ret == null) {
	      return callback("api_url_null", api_endpoint);		  
	  }
	  //console.log(f_ret);
  ...
  self.Heartbeat = function (callback) {
    ...
    //var req = [new RequestEnvelop.Requests(request_type.GET_MAP_OBJECTS, walkData.encode().toBuffer()), new RequestEnvelop.Requests(request_type.GET_HATCHED_EGGS), new RequestEnvelop.Requests(129), new RequestEnvelop.Requests(5, new RequestEnvelop.Unknown3('54b359c97e46900f87211ef6e6dd0b7f2a3ea1f5').encode().toBuffer())];
    var req = [new RequestEnvelop.Requests(request_type.GET_MAP_OBJECTS, walkData.encode().toBuffer()), new RequestEnvelop.Requests(129), new RequestEnvelop.Requests(5, new RequestEnvelop.Unknown3('54b359c97e46900f87211ef6e6dd0b7f2a3ea1f5').encode().toBuffer())];
  ...
  // elfjane 2016/9/12  
  self.SetFavoritePokemon = function (pokemonId, isFavorite, callback) {
    var _self$playerInfo3 = self.playerInfo;
    var apiEndpoint = _self$playerInfo3.apiEndpoint;
    var accessToken = _self$playerInfo3.accessToken;
    ...
    var req = new RequestEnvelop.Requests(request_type.SET_FAVORITE_POKEMON, setFavoritePokemon.encode().toBuffer());
  ...
  self.GetHatchedEggs = function (callback) {
    ...
    var req = new RequestEnvelop.Requests(request_type.GET_HATCHED_EGGS);
